...
const key_controller_1 = __importDefault(require("./controllers/key.controller"));
const to = require('await-to-js').default;
let app = new main_router_1.App([new prayers_controller_1.default(), new main_controller_1.default(), new key_controller_1.default()]);
