...
class App {
    ...
    initializeMiddlewares() {
        ...
        this.app.use('/Places/', http_proxy_middleware_1.default({ target: `https://maps.googleapis.com/maps/api/js?key=${nconf_1.default.get("GOOGLE_PLACE_KEY")}&libraries=places`,
            changeOrigin: true,
            ignorePath: true,
