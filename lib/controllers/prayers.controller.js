...
class PrayersController {
    constructor() {
        this.updatePrayersByCalculation = (request, response, next) => {
            try {
    ...
    initializeRoutes() {
        ...
        this.router.get(this.path + "/PrayersViewMobile", this._validationController.validationMiddleware(0 /* query */, prayers_lib_1.validators.ConfigValidator.createValidator()), this.getPrayersByCalculation);
        this.router.put(this.path + "/PrayersViewMobile", this._validationController.validationMiddleware(1 /* body */, prayers_lib_1.validators.ConfigValidator.createValidator()), this.updatePrayersByCalculation);
